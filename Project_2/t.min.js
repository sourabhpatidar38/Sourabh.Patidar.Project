/*
THESE CODE CREATE BY SOME ELSE AND I DOWNLOADED IT AND USING IT
AS PER MY NEED
TO CREATE ATTRACTIVE WEB PAGES
SOURABH PATIDAR
*/
            ...
            if ("add" == l && b.data().t) {
                ...
                a.wrap &&
                    ...
                    (b.wrap(
                            c(
                                "<div/>",
                                /[.#]/.test(a.wrap[0]) ?
                                "#" == a.wrap[0] ? { id: a.wrap.substr(1) } : { class: a.wrap.substr(1) } : { style: a.wrap }
                            )
                        ),
                ...
                e(a.caret, "s") &&
                    ...
                    (!0 === a.blink && (a.blink = 3 * a.speed),
                        e(a.blink) && 100 > a.blink && (a.blink = 100), !e(a.blink) && (a.blink = !1),
                        (t = c("<" + a.tag + "/>", {
                            class: "t-caret",
                            html: a.caret,
                        }).appendTo(b)),
                ...
                if (m.parent().data("paused")) u = 1;
                    ...
                    for (;;)
                        if (
                            (!0 === m.parent().data().beep && f.beep(),
                                b.append(d),
                                A && a.typing(m.parent(), d, z(), C), !/<ins.*?>[\s\S]+</.test(d) &&
                                /></.test(d) &&
                                (b = b.find(":last")),
                                k[0] && /<\w+/.test(k[0]))
                        )
                        ...
                        (((a.mistype && !a.kbd) ||
                            ...
                            ((__ += ~~(2 * Math.random()) + 1), ~~(2 * Math.random()) && (__ -= 3),
                                (k = c.merge(
                                    [
                        ...
                        (clearInterval(D),
                            ...
                            e(a.repeat) && --a.repeat, -1 < a.repeat ?
